...
const LEARN_DATA = [
  ...
  // ── CRYPTO ──
  { id:'crypto_vs_forex', cat:'crypto',
    NL:{ term:'Crypto vs Forex', short:'De belangrijkste verschillen tussen crypto en valutahandel.',
      body:'Crypto en forex lijken op elkaar maar hebben grote verschillen:\n\n• <strong>Markturen:</strong> Forex is open ma–vr (sessies). Crypto is 24/7/365 — geen sluitingstijd, ook niet in het weekend.\n• <strong>Volatiliteit:</strong> Crypto is veel volatieler. BTC kan 5–10% per dag bewegen; EUR/USD beweegt gemiddeld 0.5–1%.\n• <strong>Spreads & kosten:</strong> Crypto heeft bredere spreads en soms hogere fees (funding rates bij futures).\n• <strong>Leverage:</strong> Crypto exchanges bieden extreem hoge leverage (tot 100x+) — gevaarlijk zonder strikte risk management.\n• <strong>Liquiditeit:</strong> BTC/ETH zijn liquide, altcoins véél minder — grotere slippage bij kleinere munten.\n• <strong>Marktmanipulatie:</strong> Crypto is minder gereguleerd, "whale moves" en pumps zijn reëel.\n• <strong>Correlatie:</strong> Crypto correleert sterk intern (altcoins volgen BTC).',
      example:'EUR/USD dagelijkse range: ~50–80 pip. BTC/USD dagelijkse range: $1.000–$5.000+.' },
    EN:{ term:'Crypto vs Forex', short:'The key differences between crypto and currency trading.',
      body:'Crypto and forex look similar but have major differences:\n\n• <strong>Market hours:</strong> Forex runs Mon–Fri (sessions). Crypto is 24/7/365 — no closing time, including weekends.\n• <strong>Volatility:</strong> Crypto is far more volatile. BTC can move 5–10% per day; EUR/USD averages 0.5–1%.\n• <strong>Spreads & costs:</strong> Crypto has wider spreads and sometimes higher fees (funding rates on futures).\n• <strong>Leverage:</strong> Crypto exchanges offer extreme leverage (up to 100x+) — dangerous without strict risk management.\n• <strong>Liquidity:</strong> BTC/ETH are liquid, altcoins far less — more slippage on smaller coins.\n• <strong>Market manipulation:</strong> Crypto is less regulated; whale moves and pumps are real.\n• <strong>Correlation:</strong> Crypto is highly internally correlated (altcoins follow BTC).',
      example:'EUR/USD daily range: ~50–80 pip. BTC/USD daily range: $1,000–$5,000+.' }
  },
  { id:'crypto_hours', cat:'crypto',
    NL:{ term:'Beste tijden voor crypto traden', short:'Wanneer is de liquiditeit en volatiliteit het hoogst in crypto?',
      body:'Crypto is altijd open maar heeft duidelijke pieken:\n\n<strong>🟢 Meest actief (hoge liquiditeit + volume):</strong>\n• 14:00–22:00 BE-tijd — New York sessie, Amerikaanse traders actief\n• 08:00–12:00 BE-tijd — Europese markt opent, volume neemt toe\n• Overlap London/NY (15:00–17:00) — piekvolume\n\n<strong>🟡 Matig actief:</strong>\n• 02:00–08:00 BE-tijd — Aziatische sessie, BTC/JPY en KRW handel\n\n<strong>🔴 Rustig (vermijd grote trades):</strong>\n• 22:00–02:00 BE-tijd — laag volume, manipulatie gevaarlijker\n• Zondagochtend vroeg — historisch lagere liquiditeit\n\n<strong>Let op:</strong> Grote nieuwsevents (Fed, CPI, macro) beïnvloeden crypto net zo sterk als forex. Vrijdag 20:00+ = weekend gap risico.',
      example:'BTC doet vaak een sharp move op maandag 08:00–10:00 na een weekend gap (weekend-liquiditeitsgreep).' },
    EN:{ term:'Best times to trade crypto', short:'When is liquidity and volatility highest in crypto?',
      body:'Crypto is always open but has clear activity peaks:\n\n<strong>🟢 Most active (high liquidity + volume):</strong>\n• 14:00–22:00 CET — New York session, US traders active\n• 08:00–12:00 CET — European market opens, volume increases\n• London/NY overlap (15:00–17:00) — peak volume\n\n<strong>🟡 Moderate:</strong>\n• 02:00–08:00 CET — Asian session, BTC/JPY and KRW trading\n\n<strong>🔴 Quiet (avoid large trades):</strong>\n• 22:00–02:00 CET — low volume, manipulation more likely\n• Early Sunday morning — historically lower liquidity\n\n<strong>Note:</strong> Major news events (Fed, CPI, macro) impact crypto just as strongly as forex.',
      example:'BTC often makes a sharp move Monday 08:00–10:00 after a weekend gap (weekend liquidity grab).' }
  },
  { id:'crypto_volatility', cat:'crypto',
    NL:{ term:'Volatiliteit & risicobeheer in crypto', short:'Hoe beheer je risico bij de hogere volatiliteit van crypto?',
      body:'Door de hoge volatiliteit moet je risk management in crypto anders aanpakken:\n\n<strong>Stop-loss:</strong> Zet je SL verder dan in forex. Een normale ATR-stop voor BTC op de 1H = $500–$2.000+. Te strakke SL wordt geraak door willekeurige candles.\n\n<strong>Positiegrootte:</strong> Kleiner dan bij forex. Gebruik dezelfde % risico/trade (bv. 1%) maar met een grotere SL in absolute termen → kleinere lot.\n\n<strong>Leverage:</strong> Max 5–10x voor beginnende crypto traders. Bij 10x leverage betekent 10% beweging = 100% verlies.\n\n<strong>Weekenden:</strong> Crypto tradt ook in het weekend. Positie open laten over het weekend = gap-risico. Prop firms hebben hier soms regels over.\n\n<strong>Altcoins:</strong> Kleinere munten (buiten BTC/ETH) hebben véél hogere volatiliteit en minder liquiditeit — gebruik strengere risk management of vermijd ze.',
      example:'BTC SL van $500 op een $30.000 prijs = 1.67% — bij 1% risico per trade en €1.000 account = max €10 risico → positiegrootte erg klein.' },
    EN:{ term:'Volatility & risk management in crypto', short:'How to manage risk with crypto\'s higher volatility?',
      body:'Due to high volatility, risk management in crypto needs a different approach:\n\n<strong>Stop-loss:</strong> Place your SL further than in forex. A normal ATR-stop for BTC on 1H = $500–$2,000+. Tight SL gets hit by random wicks.\n\n<strong>Position size:</strong> Smaller than forex. Use the same % risk/trade (e.g. 1%) but with a larger absolute SL → smaller position.\n\n<strong>Leverage:</strong> Max 5–10x for beginning crypto traders. At 10x leverage, a 10% move = 100% loss.\n\n<strong>Weekends:</strong> Crypto trades on weekends too. Leaving a position open over the weekend = gap risk.\n\n<strong>Altcoins:</strong> Smaller coins (outside BTC/ETH) have much higher volatility and less liquidity — use stricter risk management or avoid them.',
      example:'BTC SL of $500 on a $30,000 price = 1.67% — at 1% risk per trade on a €1,000 account = max €10 risk → very small position size.' }
  },
  { id:'funding_rate', cat:'crypto',
    NL:{ term:'Funding Rate', short:'Periodieke kosten/winst bij crypto perpetual futures.',
      body:'Een funding rate is een periodieke betaling tussen long- en shortposities bij perpetual futures (geen vervaldatum):\n\n• <strong>Positief funding rate:</strong> Longs betalen aan shorts. Betekent de markt is bullish/overbought — waarschuwingssignaal voor long trades.\n• <strong>Negatief funding rate:</strong> Shorts betalen aan longs. Markt is bearish/oversold — potentieel short squeeze.\n\nFunding rates worden meestal elke 8 uur berekend (sommige exchanges elk uur). Typische waarde: 0.01–0.1% per 8u. Bij 0.1% per 8u = 0.3% per dag = ~109% per jaar — enorm als je lang in een positie zit!\n\n<strong>Praktisch:</strong> Hoge positieve funding = te veel longs → mogelijke liquidatie sweep nadert. Gebruik als contrarian signaal.',
      example:'BTC funding rate +0.08%/8u → longs betalen veel. Als jij short bent, ontvang je die 0.08% per 8u. Als long: kost je geld bovenop koersverlies.' },
    EN:{ term:'Funding Rate', short:'Periodic cost/profit on crypto perpetual futures.',
      body:'A funding rate is a periodic payment between long and short positions on perpetual futures (no expiry date):\n\n• <strong>Positive funding rate:</strong> Longs pay shorts. The market is bullish/overbought — warning signal for long trades.\n• <strong>Negative funding rate:</strong> Shorts pay longs. Market is bearish/oversold — potential short squeeze.\n\nFunding rates are usually calculated every 8 hours. Typical value: 0.01–0.1% per 8h. At 0.1% per 8h = 0.3% per day = ~109% per year — huge if you hold long!\n\n<strong>Practical:</strong> High positive funding = too many longs → possible liquidation sweep coming. Use as a contrarian signal.',
      example:'BTC funding rate +0.08%/8h → longs paying a lot. If you\'re short, you receive that 0.08% per 8h. If long: costs money on top of any loss.' }
  },
  { id:'btc_dominance', cat:'crypto',
    NL:{ term:'BTC Dominantie & correlaties', short:'Hoe BTC de hele cryptomarkt stuurt.',
      body:'Bitcoin Dominantie (BTC.D) = het % van de totale crypto marktcap dat BTC uitmaakt.\n\n<strong>BTC.D stijgt:</strong> Geld stroomt van altcoins naar BTC → altcoins dalen relatief meer dan BTC.\n<strong>BTC.D daalt:</strong> Geld stroomt naar altcoins → "altseason". Altcoins outperformen BTC.\n\n<strong>Correlaties om te kennen:</strong>\n• Bijna alle altcoins volgen BTC richting (correlatie 0.7–0.95)\n• ETH volgt BTC maar is iets onafhankelijker\n• In risk-off omgeving (macro paniek) dalen altcoins 2–5x harder dan BTC\n• SOL, ADA, etc. = hoge bèta → sterkere bewegingen in beide richtingen\n\n<strong>Praktisch:</strong> Als BTC een duidelijke trend heeft, trade dan mee met die trend op altcoins voor grotere moves. Ga nooit long op een altcoin als BTC dumpt.',
      example:'BTC daalt 5% → ETH daalt 7% → SOL daalt 12%. BTC.D stijgt in deze periode.' },
    EN:{ term:'BTC Dominance & correlations', short:'How BTC controls the entire crypto market.',
      body:'Bitcoin Dominance (BTC.D) = the % of total crypto market cap that BTC represents.\n\n<strong>BTC.D rising:</strong> Money flows from altcoins to BTC → altcoins drop more than BTC.\n<strong>BTC.D falling:</strong> Money flows into altcoins → "altseason". Altcoins outperform BTC.\n\n<strong>Key correlations:</strong>\n• Nearly all altcoins follow BTC direction (correlation 0.7–0.95)\n• ETH follows BTC but is slightly more independent\n• In risk-off environments (macro panic), altcoins fall 2–5x harder than BTC\n• SOL, ADA, etc. = high beta → stronger moves in both directions\n\n<strong>Practical:</strong> When BTC has a clear trend, trade with that trend on altcoins for bigger moves. Never go long on an altcoin while BTC is dumping.',
      example:'BTC drops 5% → ETH drops 7% → SOL drops 12%. BTC.D rises during this period.' }
  },
  { id:'crypto_liquidity', cat:'crypto',
    NL:{ term:'Liquiditeitszones in crypto', short:'Waar zitten de stop-clusters en liquidatiepunten in crypto?',
      body:'In crypto zijn liquiditeitszones nóg belangrijker dan in forex door de hogere leverage en zichtbare liquidatiedata:\n\n<strong>Liquidatieniveaus:</strong> Exchanges zoals Coinglass tonen open liquidatieclusters. Grote clusters = magneet voor de prijs.\n\n<strong>Psychologische niveaus:</strong> Ronde getallen (BTC $100.000, $90.000, $80.000) hebben zware stop-concentraties.\n\n<strong>Weekend gaps:</strong> BTC en ETH maken vaak een "gap fill" move vroeg in de week naar het niveau waar het weekend begon.\n\n<strong>ICT/SMC toepassing:</strong> Dezelfde principes als forex — equal highs/lows, BSL/SSL, FVG\'s — werken in crypto, maar de "sweeps" zijn groter en sneller.\n\n<strong>Exchange liquidaties:</strong> Bij hoge leverage en grote posities worden markten bewust "gemanipuleerd" om stops te raken. Zet SL altijd voorbij een duidelijk structuurpunt.',
      example:'BTC heeft gelijke highs op $95.000. Verwacht een sweep naar $95.200 om stops te raken voor de echte move.' },
    EN:{ term:'Liquidity zones in crypto', short:'Where are the stop-clusters and liquidation points in crypto?',
      body:'In crypto, liquidity zones are even more important than in forex due to higher leverage and visible liquidation data:\n\n<strong>Liquidation levels:</strong> Exchanges like Coinglass show open liquidation clusters. Large clusters = price magnet.\n\n<strong>Psychological levels:</strong> Round numbers (BTC $100,000, $90,000, $80,000) have heavy stop concentrations.\n\n<strong>Weekend gaps:</strong> BTC and ETH often make a "gap fill" move early in the week back to where the weekend started.\n\n<strong>ICT/SMC application:</strong> Same principles as forex — equal highs/lows, BSL/SSL, FVGs — work in crypto, but "sweeps" are larger and faster.\n\n<strong>Exchange liquidations:</strong> With high leverage and large positions, markets are deliberately "manipulated" to hit stops. Always place SL beyond a clear structure point.',
      example:'BTC has equal highs at $95,000. Expect a sweep to $95,200 to grab stops before the real move.' }
  },
  { id:'onchain_basics', cat:'crypto',
    NL:{ term:'On-chain analyse (basis)', short:'Wat vertelt blockchain-data over marktrichting?',
      body:'On-chain analyse kijkt naar de blockchain zelf — transacties, wallets en flows — in plaats van alleen de prijs:\n\n<strong>Exchange inflows/outflows:</strong>\n• Veel BTC naar exchanges → traders willen verkopen → bearish signaal\n• Veel BTC van exchanges weg → traders slaan op → bullish signaal (supply daalt)\n\n<strong>Whale alerts:</strong> Grote transacties (10.000+ BTC) geven aan dat grote spelers bewegen.\n\n<strong>MVRV ratio:</strong> Marktwaarde vs. gerealiseerde waarde. >3.5 = historisch overbought. <1 = undervalued.\n\n<strong>Fear & Greed Index:</strong> 0 = extreme angst (potentieel koopmogelijkheid), 100 = extreme hebzucht (potentieel verkoopmoment).\n\n<strong>Tools:</strong> Glassnode, CryptoQuant, Coinglass, Alternative.me (F&G index).\n\n<strong>Praktisch voor traders:</strong> Gebruik on-chain als extra bevestiging, niet als primair instapsignaal.',
      example:'Exchange outflow piekt + Fear & Greed onder 20 → historisch goede long-zone voor BTC op langere termijn.' },
    EN:{ term:'On-chain analysis (basics)', short:'What does blockchain data tell us about market direction?',
      body:'On-chain analysis looks at the blockchain itself — transactions, wallets, and flows — rather than just price:\n\n<strong>Exchange inflows/outflows:</strong>\n• Large BTC to exchanges → traders want to sell → bearish signal\n• Large BTC leaving exchanges → traders storing → bullish signal (supply decreases)\n\n<strong>Whale alerts:</strong> Large transactions (10,000+ BTC) indicate major players are moving.\n\n<strong>MVRV ratio:</strong> Market value vs. realized value. >3.5 = historically overbought. <1 = undervalued.\n\n<strong>Fear & Greed Index:</strong> 0 = extreme fear (potential buy opportunity), 100 = extreme greed (potential sell moment).\n\n<strong>Tools:</strong> Glassnode, CryptoQuant, Coinglass, Alternative.me (F&G index).',
      example:'Exchange outflow spikes + Fear & Greed below 20 → historically good long zone for BTC on longer timeframe.' }
  },
  { id:'crypto_costs', cat:'crypto',
    NL:{ term:'Crypto spreads & handelskosten', short:'Welke kosten heb je bij crypto traden en hoe beïnvloeden ze je strategie?',
      body:'Crypto heeft andere kostenstructuren dan forex:\n\n<strong>Spot trading (kopen/verkopen):</strong>\n• Maker fee: 0.02–0.1% (limit orders die liquidity toevoegen)\n• Taker fee: 0.05–0.15% (market orders die liquidity verwijderen)\n• Heen + terug = 0.1–0.3% round-trip\n\n<strong>Futures/perpetuals:</strong>\n• Zelfde maker/taker fees\n• + Funding rate (positief of negatief, elke 8u)\n• Bij high funding = extra kost als je mee gaat met de trend\n\n<strong>Spread:</strong> BTC/ETH hebben smalle spreads op grote exchanges. Altcoins hebben brede spreads — soms 0.5–2% bid/ask gap.\n\n<strong>Impact op strategie:</strong>\n• Scalping is duurder door fees — zorg dat je target minstens 3–5x de fee is\n• Swing trades zijn meer kostenefficiënt in crypto\n• Vergelijk: bij €10.000 positie + 0.1% taker fee heen & terug = €20 kosten — verwerk dit in je R:R',
      example:'Trade: BTC long €10.000, target +2% (+€200). Fees: 2x 0.07% = €14. Netto winst: €186. Effectieve R:R daalt licht.' },
    EN:{ term:'Crypto spreads & trading costs', short:'What costs apply to crypto trading and how do they affect your strategy?',
      body:'Crypto has different cost structures than forex:\n\n<strong>Spot trading:</strong>\n• Maker fee: 0.02–0.1% (limit orders adding liquidity)\n• Taker fee: 0.05–0.15% (market orders removing liquidity)\n• Round-trip: 0.1–0.3%\n\n<strong>Futures/perpetuals:</strong>\n• Same maker/taker fees\n• + Funding rate (positive or negative, every 8h)\n• High funding = extra cost if trading with the trend\n\n<strong>Spread:</strong> BTC/ETH have tight spreads on large exchanges. Altcoins have wide spreads — sometimes 0.5–2% bid/ask gap.\n\n<strong>Strategy impact:</strong>\n• Scalping is more expensive due to fees — ensure your target is at least 3–5x the fee\n• Swing trades are more cost-efficient in crypto',
      example:'Trade: BTC long €10,000, target +2% (+€200). Fees: 2x 0.07% = €14. Net profit: €186. Effective R:R drops slightly.' }
  },
